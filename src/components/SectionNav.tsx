...
export default function SectionNav({ sections, accent = '#EA580C' }: SectionNavProps) {
  ...
  useEffect(() => {
    // Záměrné: při připojení komponenty načteme skutečnou pozici scrollu
    // (externí stav prohlížeče) a podle ní nastavíme aktivní tečku. Bez toho
    // by navigátor po obnovení stránky ukazoval první sekci bez ohledu na to,
    // kde uživatel ve skutečnosti je.
